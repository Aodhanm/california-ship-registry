...
**v0.2.0 · LIVE: https://ships.archivesofcalifornia.com/ · DOI: [10.5281/zenodo.22105908](https://doi.org/10.5281/zenodo.22105908)** The first machine-readable registry of documented vessel visits to the Californias, from the founding of Alta California to the eve of the gold rush. Companion to the [*Archives of California*](https://archivesofcalifornia.com) calendar of the Savage transcripts.

*Cite this dataset (v0.2.0): Aodhan Coyne, "California Ship Registry, 1769–1846," Zenodo, 2026, https://doi.org/10.5281/zenodo.22105908. The concept DOI above always resolves to the latest version; the v0.2.0 version DOI is 10.5281/zenodo.22105909.*
...
- **Open `index.html` locally** to use the tool (visits table · ship index · map · traffic curve). Refresh the embedded data after data edits: `python3 scripts/update_data.py`.
...
- **DOI:** minted on Zenodo, 2026-08-26 (concept `10.5281/zenodo.22105908`, v0.2.0 `10.5281/zenodo.22105909`). This is publication #2 in the dataset-as-publication track (the C-A calendar being #1). Essays + a JOHD data paper land by v1.0.
