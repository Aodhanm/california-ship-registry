...
<div class="banner">v0.1 PRIVATE DRAFT &mdash; machine-seeded from the C-A calendar only; every row status=draft; Bancroft/Ogden/Russian source families pending (see About)</div>
<nav>
