...
## Sweep log, 2026-08-04b (the *Loo Choo* parse-garble block; Aodhan caught it)
Trigger: *Loo Choo* rows dated decades before the ship existed. **Ogden's actual entry** (local appendix txt, s.v. "Loo Choo, 1847"): ship, 639 tons, Capt. James B. Hatch, owner Wm. Appleton & Co., Boston; one voyage, left New York 26 Sep 1846, **arrived San Francisco 26 Mar 1847** (in port to 25 Apr), **San Pedro 21 May**, **San Diego 21 Jun**, left California July, Boston 8 Nov. Three California calls, 1847 only.

**What broke:** the Ogden harvest failed to recognize ~12 OCR-garbled appendix headers and attached their schedule lines to recognized entries, "Loo Choo, 1847" absorbed **375 staging rows** (330 year-mismatched); **38 leaked into visits.csv** (35 dated 1796/1806/1824 + Monterey/Santa Bárbara/San Blas "1847" calls the entry never made). All 38 dropped (archived in `data/dropped-visits.csv`); the three real calls kept with Ogden's exact dates, flag usa (Boston owner), `status=reviewed`. **2085→2047 visits.**
